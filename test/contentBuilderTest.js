describe('Montar conteúdo do serviço', function () {
  ...
  it('deve adicionar tempo estimado', function () {
    ...
    var content = [
      ...
      {
        text: 'Até 40 dias úteis é o tempo estimado para a prestação imediata deste serviço.',
        style: 'paragraph'
      },
        ];
    contentBuilder = criarContentBuilder(servico);
  ...
  it('deve adicionar tempo estimado 2', function () {
    ...
    var content = [
      ...
      {
        text: 'Entre 10 e 15 dias corridos é o tempo estimado para a prestação imediata deste serviço.',
        style: 'paragraph'
      },
        ];
    contentBuilder = criarContentBuilder(servico);
  ...
  it('deve adicionar tempo estimado 3', function () {
    ...
    var content = [
      ...
      {
        text: 'Entre 1 e 5 meses é o tempo estimado para a prestação imediata deste serviço.',
        style: 'paragraph'
      },
        ];
    contentBuilder = criarContentBuilder(servico);
  ...
  it('deve adicionar nomes populares', function () {
    ...
    var content = [
      {
        text: 'Você também pode conhecer este serviço como: Serviço para teste, Testando a interface.',
        style: 'paragraph'
      }
        ];
    contentBuilder = criarContentBuilder(servico);
    ...
    var content = [
      {
        ...
        style: 'subheader'
            ...
            '\n',
      {
        text: 'Etapa 1 - Agendamento',
        style: 'thirdheader'
      },
            '\n',
      {
        text: 'Inscrições abertas a partir de 11/08 até 31/08, o prazo final para inscrição de candidato ainda não matriculado na instituição de educação superior em que deseja se inscrever.',
        style: 'paragraph'
      },
            '\n', {
