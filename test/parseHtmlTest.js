describe('Montar objeto pdfmake', function () {
    ...
    it('parse link', function () {
        ...
        var container = [];
        var result = [[{ text: 'TítuloLei nº 6.766, de 19 de Dezembro de 1979', style: 'text' }]];
    ...
    it('parse links', function () {
        ...
        var container = [];
        var result = [[{ text: 'Test Test 2', style: 'text' }]];
    ...
    it('parse ol com link', function () {
        ...
        var result = [{ ol: [ 
            ...
            { text: 'Test', style: 'text' }], style: 'listMargin' }];
    ...
    it('parse markdown page example 2', function () {
        ...
        var result = [ [ { text: 'Some of these words ', style: 'text', headlineLevel: 2 }, 
            { text: 'are emphasized.Some of these words ', style: 'paragraph' }, 
            { text: 'are emphasized also.', style: 'paragraph' }, 
            [ { text: 'Use two asterisks for ', style: 'text', headlineLevel: 2 }, 
            { text: 'strong emphasis.Or, if you prefer, ', style: 'text', headlineLevel: 2 }, 
