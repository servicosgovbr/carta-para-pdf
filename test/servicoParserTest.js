describe("O parse do xml do serviço", function () {
    ...
    it("deve retornar o contato", function () {
     ...
     it("deve retornar o orgão", function () {
        expect(servicoParser.parseOrgao(xml)).toEqual({ id: 'http://estruturaorganizacional.dados.gov.br/id/unidade-organizacional/61283' });
    });
    ...
    it("deve retornar tempo total estimado", function () {
        expect(servicoParser.parseTempoTotalEstimado(xml)).toEqual({ min: undefined, max: '40', unidade: 'dias-uteis', descricao: '' });
    });

    it("deve retornar tempo total estimado 2 com exceção", function () {
        expect(servicoParser.parseTempoTotalEstimado(xml2)).toEqual({ min:'10', max: '15', unidade: 'dias-corridos', descricao: 'Exceção: Pode demorar de 20 a 25 dias corridos' });
    });
